...
#define INSTANTIATE_REAL_TEMPLATE_NOARGS(f, dtype) template __host__ __device__ dtype f<dtype>
...
#define REAL_TEMPLATE_H template <typename scalar_t, typename T> __host__ __device__
#define REAL_TEMPLATE template <typename scalar_t, typename T=scalar_t> __host__ __device__
