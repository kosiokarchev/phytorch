...
h = Constant('h', 6.626_070_040e-34 * J * s, 'Planck constant')
k = Constant('k', 1.380_648_52e-23 * J / K, 'Boltzman constant')
N_A = Constant('N_A', 6.022_140_857e23, 'Avogadro constant')
e = Constant('e', 1.602_176_620_8e-19 * C, 'elementary charge')
...
# Measured
alpha = α = Constant('alpha', 7.297_352_566_4e-3, 'fine-structure constant')
G = Constant('G', 6.674_08e-11 * N * m**2 / kg**2, 'Newtonian constant of gravitation')
m_p = Constant('m_p', 1.672_621_898e-27 * kg, 'proton mass')
m_n = Constant('m_n', 1.674_927_471e-27 * kg, 'neutron mass')
m_e = Constant('m_e', 9.109_383_56e-31 * kg, 'electron mass')
u = Constant('u', 1.660_539_040e-27 * kg, 'atomic mass constant')
# --------
...
# TODO: template for constant collections
